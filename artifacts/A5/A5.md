...
| R05                | Auction(**id**, author NN, description NN, duration NN CK duration>5, ISBN NN, title NN, dateCreated NN DF Today, status DF 'waitingApproval' CK status IN AuctionStatus, dateApproved CK status='approved', dateRemoved CK status ='removed', __idPublisher__ → Publisher, __idLanguage__-> Language NN, __idSeller__ → Member NN) |
...
| R11                | Bid(**idBuyer**-> Member, **idAuction** -> Auction, bidDate NN, bidValue CK bidValue>0.0)|
