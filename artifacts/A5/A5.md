...
<tr><td colspan="2">**Keys**: { id, username }   </td></tr>
...
<table>
    ...
    <tr>
        <td colspan="2">**Keys**: { id, countryName }</td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td colspan="2">**Table R03** (Member)  </td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id, email, username} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R04** (RequestedTermination)</td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td colspan="2">**Table R05** (Auction)  </td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id} </td>
    </tr>
...
<table>
    ...
    <tr>
        <td colspan="2">**Keys**: {id, categoryName} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R07** (Publisher)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id, publisherName} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R08** (Language)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id, language } </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R09** (CategoryAuction)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {idCategory , idAuction} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R10** (WishList)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {idBuyer , idAuction} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R12** (AuctionModification)  </td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id} </td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R13** (Notification)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id} </td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R14** (NotificationAuction)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {idNotification, idAuction} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R15** (Image) </td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id, source} </td>
    </tr>
    <tr>
        <td colspan="2">**Functional Dependencies**</td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R16** (Message)  </td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: {id} </td>
    </tr>
...
<table>
    <tr>
        <td colspan="2">**Table R17** (Comment)</td>
    </tr>
    <tr>
        <td colspan="2">**Keys**: { id } </td>
    </tr>
