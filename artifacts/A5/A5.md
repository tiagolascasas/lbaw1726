...
Como todos os esquemas de relações estão na forma normal *Boyce–Codd Normal Form* (BCNF), o modelo relacional encontra-se inteiramente normalizado, não tendo sido necessário realizar nenhumas normalizações extra.
