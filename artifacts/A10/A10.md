...
Foi obtida uma pontuação de 15/18 no teste de acessibilidade. O motivo por não cumprirmos com as 3 restantes são as seguintes:
...
Foi obtida uma pontuação de 25/28 no teste de usabilidade. O motivo por não cumprirmos com as 3 restantes são as seguintes:
...
Não existe qualquer intenção de ver o site integrado com redes sociais, e portanto ter estas *tags* é desnecessário.
