        ...
        <div class="container p-5 align-self-center">
            ...
            <section class="py-2">
                <div class="row">
                    ...
                    <div class="col-md-6 my-4">
                        <img class=img-fluid src=img/bookhub_about.jpeg alt="library">
                    </div>
                </div>
            </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 text-center mb-4">
                    <img class="rounded-circle img-fluid d-block mx-auto" src="img/daniel.jpg" alt="Daniel Azevedo photo">
                    <h4>Daniel Azevedo<a href="https://github.com/3rdvision" class="btn btn-social-icon btn-github"><i class="fab fa-github"></i></a></h4>
                    <p>Developer</p>
                </div>
                <div class="col-lg-3 col-sm-6 text-center mb-4">
                    <img class="rounded-circle img-fluid d-block mx-auto" src="img/nelson.jpg" alt="Nelson Costa photo">
                    <h4>Nelson Costa<a href="https://github.com/mrnelsoncosta" class="btn btn-social-icon btn-github"><i class="fab fa-github"></i></a></h4>
                    <p>Developer</p>
                </div>
                <div class="col-lg-3 col-sm-6 text-center mb-4">
                    <img class="rounded-circle img-fluid d-block mx-auto" src="img/ruben.jpg" alt="Ruben Torres photo">
                    <h4>Rúben Torres<a href="https://github.com/rjstorres" class="btn btn-social-icon btn-github"><i class="fab fa-github"></i></a></h4>
                    <p>Developer</p>
                </div>
                <div class="col-lg-3 col-sm-6 text-center mb-4">
                    <img class="rounded-circle img-fluid d-block mx-auto" src="img/tiago.jpg" alt="Tiago Santos photo">
